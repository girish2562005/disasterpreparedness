...
-- Create a new secure policy for students to access only the view data
CREATE POLICY "Students can view questions without sensitive data" 
ON public.quiz_questions 
FOR SELECT 
USING (
  (get_current_user_role() = 'student'::text OR get_current_user_role() IS NULL)
  AND FALSE  -- This ensures students cannot directly access the table
);
